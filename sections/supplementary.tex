...
\noindent\begin{tabular}{@{}p{0.22\linewidth}p{0.34\linewidth}p{0.38\linewidth}@{}}
  ...
  \S3 KPI landscape & Methods; Results; Discussion & Figs~S2--S3; Tables~S1--S2; Fig.~S8 \\
  \S4 Eff.--power & Results (\cref{sec:eff_power}) & Figs~S6--S7 \\
  \S5 QC & Methods (\cref{sec:qc}); Discussion & Normality note; Note~S1 \\
  \S6 Practitioner tool & Discussion (\cref{sec:practical_guidance}) & Note~S4 \\
  \bottomrule
\end{tabular}
