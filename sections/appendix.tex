...
The binary outcome $Y\in\{0,1\}$ is the match outcome; it is \emph{not} a deterministic function of $X$. Under Assumption~(A2) (Gaussian discriminant model, \S2.2.1), the class-conditional distributions are
\[
