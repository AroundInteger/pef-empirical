...
\Cref{sec:theory} develops the theoretical framework: the PEF formula, the PEF--information content relationship, and boundary analysis. \Cref{sec:methods} describes the validation methodology. \Cref{sec:results} presents results. \Cref{sec:discussion} discusses implications and limitations. Mathematical derivations with full intermediate steps appear in Supplementary Note~S3 (\cref{sec:si_note_s3}).
