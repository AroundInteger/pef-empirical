...
\begin{table}[t]
  ...
  \begin{minipage}{0.95\linewidth}\small
    $^{\dagger}$Mean five-fold cross-validated accuracy improvement (relative minus absolute features) across 50 Monte Carlo trials per scenario cell ($\delta/\sigma_{\mathrm{A}}=1$). Standard errors are $\approx$0.8--1.0 percentage points (Supplementary~Note~S2).
  \end{minipage}
\end{table}
