...
The algebraic steps from \cref{eq:var_sum} to \cref{eq:pef} are elementary consequences of the bivariate variance formula, and related efficiency expressions for unequal-variance paired designs appear in the experimental-design literature \parencite{fisher1935,welch1947,cochran1977}. We do not claim priority for the formula itself. The contributions of this paper are:
...
Readers familiar with design efficiency will recognise \cref{eq:pef} as a variance ratio; the framework built around it, and its consequences for feature engineering and machine learning, are the primary contributions.
