...
For random variables $X_{\mathrm{A}}$ and $X_{\mathrm{B}}$ with variances $\sigma^{2}_{\mathrm{A}}$, $\sigma^{2}_{\mathrm{B}}$ and correlation $\rho$, variance of the difference is
\begin{equation}
