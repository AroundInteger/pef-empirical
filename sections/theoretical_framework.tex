...
\noindent For unpaired measurements ($\rho=0$), this variance is $\sigma^{2}_{\mathrm{A}}(1+\kappa)$. The Paired Efficiency Factor is the ratio of unpaired to paired variance, i.e.\ the expression in~\cref{eq:pef}:
\begin{equation*}
