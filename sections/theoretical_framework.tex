...
\begin{enumerate}
  ...
  \item empirical quadrant exemplars demonstrating that the $(\kappa,\rho)$ taxonomy correctly predicts the direction of machine learning gain when signal strength (the standardised mean separation $\delta/\sigma_{\mathrm{A}}$, defined in \cref{sec:mi_setup}) is controlled (\cref{sec:exemplars});
