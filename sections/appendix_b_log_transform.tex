...
The transformation was applied to all 24 rugby union KPIs from the primary dataset ($n=240$ games). \Cref{tab:log_summary} summarises the aggregate results, and \cref{tab:log_top} reports the five KPIs with the largest improvement.
