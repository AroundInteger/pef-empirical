...
%   metric: 'eta' (default) or 'I' for legend annotation on (kappa,rho) axes.
    ...
    for i = 1:size(spec, 1)
        ...
        if isfinite(rp1) && isfinite(kp1) && isfinite(rp2) && isfinite(kp2)
            ...
            scatter(ax, rp1, kp1, ST.ms_exemplar_open, clr, mk, 'LineWidth', 1.2, ...
        ...
        scatter(ax, rp_plot, kp_plot, ST.ms_exemplar, clr, mk, 'filled', ...
            'MarkerEdgeColor', 'k', 'LineWidth', 1.1, 'DisplayName', leg_str);
