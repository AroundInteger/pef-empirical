...
%  figures/Figure_3.png  -- confirmatory eta vs DeltaML (exemplars + rucks foil)
...
% Merge PEF params into ML table (exemplars, correlations)
...
addpath(fullfile(fileparts(THIS_DIR), 'matlab_figures'));
regenerate_figure_3_from_outputs(fullfile(FIG_DIR, 'Figure_3.png'));
...
% Figure 3 is drawn by scripts/matlab_figures/regenerate_figure_3_from_outputs.m
...
%   redefines macros so repeated compilation does not cause conflicts.
    ...
    lut = { ...
        ...
        'Table4','Q2',           'ci_lo',        'PEFqTwoCIlo',         'dp3'; ...
        'Table4','Q2',           'ci_hi',        'PEFqTwoCIhi',         'dp3'; ...
        'Table4','Q3',           'mean_eta',    'PEFqThreeMeanEta',    'dp3'; ...
        'Table4','Q3',           'n_kpis',       'PEFqThreeNkpis',      'int'; ...
        'Table4','Q3',           'mean_ml_impr', 'PEFqThreeMLimpr',     'pct'; ...
        'Table4','Q3',           'ci_lo',        'PEFqThreeCIlo',       'dp3'; ...
        'Table4','Q3',           'ci_hi',        'PEFqThreeCIhi',       'dp3'; ...
