...
\noindent\begin{tabular}{@{}p{0.22\linewidth}p{0.34\linewidth}p{0.38\linewidth}@{}}
  ...
  \midrule
  \S1 Theory & Theory; Fig.~2; Intro.\ (Pitman) & Algebra; Pitman ARE; Fig.~S1 \\
...
\begin{figure}[h]
  ...
  \caption{Idealised probit simulation (SI~\S2) under (A1)--(A2).
    ...
    $\tfrac12\log\kappa$, a monotone relabelling of $\kappa$;
...
\begin{figure}[h]
  ...
  \caption{Idealised probit companion (SI~\S2): iso-$\eta$ vs.\ iso-$I(X;Y)$.
