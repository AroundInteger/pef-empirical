...
tabular@p0.22p0.34p0.38@
  ...
  **SI block** & **Main paper** & **Contents** \\
  ...
  2 Info. surface & Theory; Fig. 2 & Fig. S1 \\
  3 KPI landscape & Methods; Results; Discussion & Figs S2--S3; Tables S1--S2; Fig. S8 \\
  4 Eff.--power & Results ((sec:eff_power)) & Figs S6--S7 \\
  5 QC & Methods ((sec:qc)); Discussion & Normality note; Note S1 \\
  6 Practitioner tool & Discussion ((sec:practical_guidance)) & Note S4 \\
...
# SI Section 2: Information Surface (Theory)
...
# SI Section 3: Sports KPI Landscape
...
# SI Section 4: Efficiency--Power Diagnostics
...
# SI Section 6: Practitioner Diagnostic
