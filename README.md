...
Captions for S1–S8 are in `sections/supplementary.tex` (subsection order follows main-text first citation; figure counters are set explicitly so S-labels stay S1–S8).
