...
\title{When Should Team KPIs Be Relativised? Paired Efficiency, Information Content, and Match-Outcome Prediction in Rugby Union and Football}

% Co-author order and affiliations: confirm with Bennett/Kilduff/Scott group before submission (roadmap D4).
\author{%
  Rowan Brown\thanks{Corresponding author. \href{mailto:m.r.brown@swansea.ac.uk}{m.r.brown@swansea.ac.uk}.} \\
